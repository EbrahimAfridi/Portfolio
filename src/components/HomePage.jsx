...
function HomePage () {
    return(
        <div className="grid grid-cols-3 gap-2 m-16 grid-rows-[95%]">
            ...
            {/* Text Grid */}
            <div className=" mb-20 col-start-1 col-end-3 pt-20 pl-5 text-5xl pr-36̥">
            ...
            <div className= "col-start-3 mb-20 ml-20 bg-black rounded-sm w-fit h-fit">
                <img className="h-[300px]" src={profileImage} alt="Profile Picture" />
            </div>
            ...
            <div className="flex flex-row items-center justify-between col-span-3 grid-rows-[5%]">
                <div className='flex flex-row gap-8 pl-4'>
                    ...
                    <a href="https://www.linkedin.com/in/ebrahim-afridi-83188b219/" target="_blank" rel="noopener noreferrer">
                        <img className='flex flex-row justify-between hover:cursor-pointer ' src={linkedIn} alt="linked in logo" />
                    </a>
                ...
                <a href="http://gmail.com" target="_blank" rel="noopener noreferrer">
                    <p className='pr-12 hover:cursor-pointer font-rubik'>afridiebrahimck@gmail.com</p>
                </a>
